...
```text
ghcr.io/solarssk/ssf-transmitter:0.5.13     # pinned release
ghcr.io/solarssk/ssf-transmitter:latest      # tracks main

docker.io/solarssk/ssf-transmitter:0.5.13   # same image, Docker Hub
...
Swap `image:` to `docker.io/solarssk/ssf-transmitter:0.5.13` to pull from Docker Hub instead — skips the `docker login` GHCR needs.
